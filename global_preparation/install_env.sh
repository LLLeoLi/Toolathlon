...
# uvx
uv tool install git+https://github.com/LLLeoLi/Office-PowerPoint-MCP-Server@2f3b9531519d193623108d9dc2d2738b86cf18c0
...
cd ./local_servers
git clone https://github.com/LLLeoLi/arxiv-latex-mcp.git
cd arxiv-latex-mcp
